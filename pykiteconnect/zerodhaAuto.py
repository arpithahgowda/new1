...
#credentials
api_key = 'mgo0cpu0qgooilh8'
api_secret = '8retc59vcbx2no9kptxawcivk08wap4i'
account_username = 'ZR0201'
account_password = 'Appu@0202'
...
driver = webdriver.Chrome(executable_path='/Users/arpithah/Desktop/chromedriver',options=options)
