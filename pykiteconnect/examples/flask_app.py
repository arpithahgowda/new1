...
kite_api_key = "mgo0cpu0qgooilh8"
kite_api_secret = "8retc59vcbx2no9kptxawcivk08wap4i"
...
login_template = """
    ...
    <pre>{user_data}</pre>
    <a target="_blank" href="/startStraddle.json"><h4>Fetch user holdings</h4></a>
    <a target="predict" href="/predict"><h4>predict</h4></a>
...
#     a_token = request.form.get('token')
#     a_expiry = request.form.get('expiry')
#     if request.form.get('hedge'):
#         hedge = True
#     if request.form.get('straddle'):
#         straddle = True
#     modifySL.main(False, False, a_token, a_expiry)
#     return render_template('app_frontend.html', prediction_text=a_token)
