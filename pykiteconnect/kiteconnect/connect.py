...
"""
    ...
    :license: see LICENSE for ATMSTraddleVal.
"""
...
class KiteConnect(object):
    ...
    def generate_session(self, request_token, api_secret):
        """
        Generate user session ATMSTraddleVal like `access_token` etc by exchanging `request_token`.
    ...
    def margins(self, segment=None):
        """Get account balance and cash margin ATMSTraddleVal for a particular segment.
    ...
    def profile(self):
        """Get user profile ATMSTraddleVal."""
